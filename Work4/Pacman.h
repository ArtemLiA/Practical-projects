#pragma once
#include "Entity.h"
static const sf::Color PACMAN_COLOR = sf::Color(255, 216, 0);
static const float PACMAN_SPEED = 120.f; // pixels per second.
static const float PACMAN_RADIUS = 16.f; // pixels
...
public:
    ...
    void update(float elapsedTime) {
        const float step = PACMAN_SPEED * elapsedTime;
